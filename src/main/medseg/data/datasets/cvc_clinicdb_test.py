...
CVC_CLINICDB_TEST_DEFAULT_PATH = "{project_root}/data/datasets/cvc_clinicdb-test"


class CvcClinicDbTest(MedsegDataset):

    def __init__(
            self,
            split_type: SplitType,
            dataset_path: str = CVC_CLINICDB_TEST_DEFAULT_PATH,
