...
CVC_COLONDB_TEST_DEFAULT_PATH = "{project_root}/data/datasets/cvc_colondb-test"


class CvcColonDbTest(MedsegDataset):

    def __init__(
            self,
            split_type: SplitType,
            dataset_path: str = CVC_COLONDB_TEST_DEFAULT_PATH,
