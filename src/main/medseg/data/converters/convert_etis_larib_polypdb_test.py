...
def convert_etis_larib_polypdb_test(in_path=None, out_path=None, copy_files=True):
    """
    Convert the ETIS-Larib PolypDB test subset from the predefined PraNet / HarDNet-MSEG / HarDNet-DFUS dataset split to be
...
if __name__ == "__main__":
    convert_etis_larib_polypdb_test()
