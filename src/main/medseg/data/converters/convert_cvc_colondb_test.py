...
def convert_cvc_colondb_test(in_path=None, out_path=None, copy_files=True):
    """
    Convert the CVC-ColonDB test subset from the predefined PraNet / HarDNet-MSEG / HarDNet-DFUS dataset split to be
